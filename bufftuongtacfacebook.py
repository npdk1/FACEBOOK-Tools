...
\033[1;37m- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\033[1;34m  🌸 \033[1;33mBản Quyền Tool Thuộc:\033[1;31m Nguyễn Phan Đăng Khoa
...
def nghigiailao(o):
    while o > 0:
        o -= 1
        print(f"\033[38;5;99m🌸 [Nka][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
        print(f"\x1b[38;5;226m🌸 [Nka][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
        print(f"\x1b[38;5;207m🌸 [Nka][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
