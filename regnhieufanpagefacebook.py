...
class API_PRO5_NTK:
    def banner(self):
        os.system('title Tool Reg Page Profile Đa Luồng')
        os.system("cls" if os.name == "nt" else "clear")
        banner = '''
\033[1;34m╔═══════════════════════════════════════════════════════════════════════════════╗
\033[1;34m║\033[1;34m   ║\033[1;92m Admin: \033[1;97m Nguyễn Phan Đăng Khoa \033[1;34m    ║
\033[1;34m║\033[1;34m   ║\033[1;92m Momo: \033[1;93m Nguyễn Phan Đăng Khoa    \033[1;34m  ║
\033[1;34m║\033[1;97m                                                                     ║
    \033[1;34m   ║\033[1;92m MB Bank:\033[1;97m 23130220071234   \033[1;34m               ║
\033[1;34m║\033[1;34m   ║\033[1;92m Zalo : \033[1;93mĐăng Khoa\033[1;34m                  ║
\033[1;34m║\033[1;34m   ║\033[1;92m Support: \033[1;95m Nguyễn Phan Đăng Khoa   \033[1;34m║
\033[1;34m╚═══════════════════════════════════════════════════════════════════════════════╝
\033[1;32m Tool Reg Page Profile Đa Luồng
    ...
    def ntk_delaytool(self, p):
        ...
        while(p>1):
            p=p-1
            print(f'\033[1;36m[STATUS][|][LO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[STATUS][/][LOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[STATUS][-][LOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[STATUS][+][LOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[STATUS][\][LOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[STATUS][|][LOADING.][{p}]','     ',end='\r');sleep(1/6)
